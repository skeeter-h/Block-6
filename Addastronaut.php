...
<h2>Please Add a New Astronaut to the Database: </h2>
		...
		if (isset($_POST['submit'])) {
			...
			$sql = "INSERT INTO astronaut (astronaut_name, no_missions, nationality, gender) VALUES ('$name', '$missions','$nat','$gender')";
			//Query to insert the specified data in each attribute

			if($name == null || $missions == null || $nat == null) { //Making sure that all fields have been filled out so as not to submit unfilled data
